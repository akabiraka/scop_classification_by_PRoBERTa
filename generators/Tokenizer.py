...
t = Tokenizer()
t.do_linear(pd.read_csv("data/splits/all.txt"), 0, 100, "data/preprocess/tokenized/all.txt")
t.do_linear(pd.read_csv("data/splits/train.txt"), 0, 100, "data/preprocess/tokenized/train.txt")
t.do_linear(pd.read_csv("data/splits/val.txt"), 0, 100, "data/preprocess/tokenized/val.txt")
t.do_linear(pd.read_csv("data/splits/test.txt"), 0, 100, "data/preprocess/tokenized/test.txt")
